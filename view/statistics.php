    <div class="w-100 h-30">
        <div class="jumbotron h-30 m-md-5 shadow p-3 mb-5 rounded" style="min-height: 25vh;">
        ...
        <div class="col-12">
            <div class="m-5" style="">
                <div class="row justify-content-center">
                    <div class="col-12 col-sm-12 col-md-6 col-xl-4 m-1" id="categories"></div>
                    <div class="col-12 col-sm-12 col-md-6 col-xl-4 m-1" id="category-query">
            ...
            <div class="m-5" style="">
                <div class="row justify-content-center">
                    <div class="table-responsive col-12 col-sm-12 col-md-10 col-xl-8" id="rank"></div>
                </div>
            </div>
        </div>
    </div>
